...
using SleepTracker.Droid.NativeRenderers;
using System;
using System.IO;
...
namespace SleepTracker.Droid.NativeRenderers
{
    public class BlurredImageRenderer : ViewRenderer<BlurredImage, ImageView>
    {
        ...
        private async void UpdateBitmap(Image previous = null)
        {
            ...
            {
                SetIsLoading(true);
                ((BlurredImageView)Control).SkipInvalidate();
        ...
        private void SetIsLoading(bool value)
        {
            ...
            ((IElementController)Element).SetValueFromRenderer((BindablePropertyKey)fieldInfo.GetValue(null), value);
        }
    }
}